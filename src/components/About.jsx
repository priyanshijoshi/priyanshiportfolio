                    ...
                    >
                        <div className="relative aspect-square w-full max-w-sm mx-auto mb-10">
                            ...
                            <motion.div
                                ...
                                className="absolute -bottom-4 left-1/2 -translate-x-1/2 glass px-3 py-1 rounded-full text-sm flex items-center gap-1 font-semibold text-cyan-400"
                            >
                        ...
                        <div className="w-full max-w-sm space-y-4">
                            <div className="glass-card p-5 relative overflow-hidden text-left">
                                ...
                                <p className="text-cyan-400 text-xs mt-1 font-mono">Class of 2026</p>
                            </div>
                            ...
                            {skills.map((skill, idx) => (
                                ...
                                >
                                    <div className="flex justify-between mb-1">
                                        ...
                                        <span className="text-cyan-400 font-mono font-semibold">{skill.level}%</span>
                                    </div>
                            ...
                            <div className="flex flex-wrap gap-2">
                                {designExpertise.map((exp, idx) => (
                                    <motion.span
                                        ...
                                        className="px-3 py-1 rounded-full glass text-sm text-cyan-400 cursor-pointer border border-white/5"
                                    >
                                        {exp}
                                    </motion.span>
                                ))}
                            ...
                            <div className="flex flex-wrap gap-2">
                                {softSkills.map((skill, idx) => (
                                    <motion.span
                                        ...
                                        className="px-3 py-1 rounded-full glass text-sm text-purple-400 cursor-pointer border border-white/5"
                                    >
                                        {skill}
                                    </motion.span>
                                ))}
