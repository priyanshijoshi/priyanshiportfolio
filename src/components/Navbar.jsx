    ...
    >
      <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
        ...
        {menuOpen && (
          ...
          >
            ...
            <a
              ...
              className="text-sm uppercase tracking-wider text-white/70 hover:text-white mt-2 border-t border-white/10 pt-4"
        ...
        <motion.a
          ...
          whileHover={{ scale: 1.05 }}
          whileTap={{ scale: 0.95 }}
          className="hidden md:block px-5 py-2 rounded-full bg-gradient-to-r from-cyan-500 to-purple-600 text-white text-sm font-semibold text-center"
        >
          Resume
        </motion.a>
      </div>
